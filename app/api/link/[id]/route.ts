...
import { getWrappedLink, incrementClickCount } from '@/lib/services/link-wrapping';
import { detectBot, logBotDetection, checkRateLimit, createBotResponse } from '@/lib/utils/bot-detection';
