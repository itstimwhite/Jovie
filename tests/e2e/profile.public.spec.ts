...
test.describe('Public Profile Performance', () => {
  test.describe('Tim Profile Rendering', () => {
    ...
    test('shows at least one social link', async ({ page }) => {
      ...
      const socialElements = page.locator('[href*="instagram"], [href*="twitter"], [href*="spotify"], [href*="tiktok"], button[title*="Follow"], a[title*="Follow"]');
    ...
    test('measures Core Web Vitals with Playwright traces', async ({ page }) => {
    ...
    test('social links are accessible and functional', async ({ page }) => {
      ...
      const socialLinks = page.locator('[href*="instagram"], [href*="twitter"], [href*="spotify"], [href*="tiktok"]');
    ...
    test('performance budget compliance in CI environment', async ({ page }) => {
      ...
      const socialElements = page.locator('[href*="instagram"], [href*="twitter"], [href*="spotify"], [href*="tiktok"], button[title*="Follow"]');
      await expect(socialElements.first()).toBeVisible();
    });
  });
  ...
  test.describe('Performance Edge Cases', () => {
    ...
    test('measures Time to Interactive (TTI) approximation', async ({ page }) => {
      const startTime = Date.now();
