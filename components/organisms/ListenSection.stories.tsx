...
const mockDSPs: AvailableDSP[] = [
  ...
  },
  {
    key: 'apple_music',
    name: 'Apple Music',
    url: 'https://music.apple.com/us/artist/ariana-grande/1227269205',
    config: {
      name: 'Apple Music',
      color: '#FA243C',
      textColor: 'white',
...
const meta: Meta<typeof ListenSection> = {
...
export const NoDeepLinks: Story = {
  args: {
    handle: 'arianagrande',
    dsps: mockDSPs,
    size: 'md',
