  ...
  return (
    <>
      <button
        ...
        {...getReferenceProps()}
        className={`flex items-center gap-3 transition-colors focus-ring-themed ${showUserInfo ? 'rounded-md p-2 text-left interactive-hover' : 'justify-center w-8 h-8 rounded-full surface-hover hover:surface-pressed'}`}
      >
        {userImageUrl ? (
          <Image
            src={userImageUrl}
