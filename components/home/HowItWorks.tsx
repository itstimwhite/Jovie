export function HowItWorks() {
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          viewBox="0 0 24 24"
          stroke="currentColor"
          aria-label="Music streaming icon"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-blue-500/50 via-purple-500/50 to-cyan-500/50"
        role="separator"
        aria-hidden="true"
      />
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center mb-16">
          <div className="mb-8">
            <div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 text-sm font-medium text-purple-400"
              role="img"
        ...
        <div className="mx-auto max-w-6xl">
          <ol className="grid grid-cols-1 gap-12 md:grid-cols-3" role="list">
            {steps.map((step, index) => (
              <li key={step.number} className="relative group">
                {/* Connection line - Linear-style */}
                {index < steps.length - 1 && (
                  <div
                    className="absolute left-1/2 top-8 hidden h-px w-full -translate-x-1/2 bg-gradient-to-r from-blue-500/30 via-purple-500/30 to-cyan-500/30 md:block"
                    aria-hidden="true"
                  />
                )}
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-gray-50/80 dark:bg-white/5 backdrop-blur-sm border border-gray-200 dark:border-white/10 rounded-2xl p-8 hover:border-gray-300 dark:hover:border-white/20 transition-all duration-300">
                    <div className="text-center">
                      <div
                        className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-purple-600 text-white shadow-lg"
                        aria-hidden="true"
                      >
                        {step.icon}
                      </div>
