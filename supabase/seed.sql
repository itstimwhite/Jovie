...
INSERT INTO creator_profiles (user_id, creator_type, username, display_name, bio, avatar_url, is_public) VALUES
  ('seed_user_1', 'artist', 'musicmaker', 'Music Maker', 'I create electronic music and love to collaborate.', null, true),
  ('seed_user_2', 'artist', 'privateartist', 'Private Artist', 'This is a private profile for testing RLS.', null, false),
  ('seed_user_3', 'artist', 'popstar', 'Pop Star', 'Chart-topping hits and energetic performances!', null, true)
