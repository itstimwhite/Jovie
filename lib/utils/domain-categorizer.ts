...
const SENSITIVE_DOMAINS: Record<string, SensitiveDomainRecord> = {
  ...
  'onlyfans.com': { domain: 'onlyfans.com', category: 'adult', alias: 'Premium Content' },
  'fansly.com': { domain: 'fansly.com', category: 'adult', alias: 'Exclusive Content' },
  'pornhub.com': { domain: 'pornhub.com', category: 'adult', alias: 'Entertainment' },
  'xvideos.com': { domain: 'xvideos.com', category: 'adult', alias: 'Entertainment' },
  'xhamster.com': { domain: 'xhamster.com', category: 'adult', alias: 'Entertainment' },
  'redtube.com': { domain: 'redtube.com', category: 'adult', alias: 'Entertainment' },
  'chaturbate.com': { domain: 'chaturbate.com', category: 'adult', alias: 'Live Streaming' },
  'cam4.com': { domain: 'cam4.com', category: 'adult', alias: 'Live Streaming' },
  'stripchat.com': { domain: 'stripchat.com', category: 'adult', alias: 'Live Streaming' },
  'myfreecams.com': { domain: 'myfreecams.com', category: 'adult', alias: 'Live Streaming' },
  
  // Gambling - use generic entertainment/sports terms
  'draftkings.com': { domain: 'draftkings.com', category: 'gambling', alias: 'Sports Entertainment' },
  'fanduel.com': { domain: 'fanduel.com', category: 'gambling', alias: 'Sports Entertainment' },
  'betmgm.com': { domain: 'betmgm.com', category: 'gambling', alias: 'Gaming Platform' },
  'caesars.com': { domain: 'caesars.com', category: 'gambling', alias: 'Entertainment' },
  'bet365.com': { domain: 'bet365.com', category: 'gambling', alias: 'Sports Platform' },
  'pokerstars.com': { domain: 'pokerstars.com', category: 'gambling', alias: 'Card Games' },
  '888casino.com': { domain: '888casino.com', category: 'gambling', alias: 'Gaming Platform' },
  'bovada.lv': { domain: 'bovada.lv', category: 'gambling', alias: 'Sports Platform' },
  
  // Crypto/Trading - use generic finance terms
  'coinbase.com': { domain: 'coinbase.com', category: 'crypto', alias: 'Digital Assets' },
  'binance.com': { domain: 'binance.com', category: 'crypto', alias: 'Trading Platform' },
  'crypto.com': { domain: 'crypto.com', category: 'crypto', alias: 'Digital Finance' },
  'robinhood.com': { domain: 'robinhood.com', category: 'trading', alias: 'Investment Platform' },
  'webull.com': { domain: 'webull.com', category: 'trading', alias: 'Investment Platform' },
  
  // Dating - use generic social terms
  'tinder.com': { domain: 'tinder.com', category: 'dating', alias: 'Social Platform' },
  'bumble.com': { domain: 'bumble.com', category: 'dating', alias: 'Social Network' },
  'seeking.com': { domain: 'seeking.com', category: 'dating', alias: 'Premium Dating' },
  'adultfriendfinder.com': { domain: 'adultfriendfinder.com', category: 'dating', alias: 'Social Platform' },
  
  // High-interest lending - use generic finance terms
  'cashadvance.com': { domain: 'cashadvance.com', category: 'lending', alias: 'Financial Services' },
  'paydayloan.com': { domain: 'paydayloan.com', category: 'lending', alias: 'Financial Services' },
  'quickcash.com': { domain: 'quickcash.com', category: 'lending', alias: 'Financial Services' },
};
 ...
 */
export function getCrawlerSafeLabel(domain: string, fallback: string = 'External Link'): string {
...
export function containsSensitiveKeywords(text: string): boolean {
  const sensitiveKeywords = [
    'porn', 'adult', 'xxx', 'nsfw', 'sex', 'casino', 'gambling', 'bet',
    'crypto', 'bitcoin', 'ethereum', 'trading', 'forex', 'loan', 'cash advance'
  ];
