  ...
  addCoreWebVitalsRules() {
    this.rules = [
      ...
      { 
        ...
        threshold: 2500, 
        severity: 'warning',
        description: 'Largest Contentful Paint exceeds 2.5s (Google "Needs Improvement" threshold)'
      },
      { 
        metric: 'lcp', 
        threshold: 4000, 
        severity: 'error',
        description: 'Largest Contentful Paint exceeds 4s (Google "Poor" threshold)'
      },
      ...
      { 
        ...
        threshold: 100, 
        severity: 'warning',
        description: 'First Input Delay exceeds 100ms (Google "Needs Improvement" threshold)'
      },
      { 
        metric: 'fid', 
        threshold: 300, 
        severity: 'error',
        description: 'First Input Delay exceeds 300ms (Google "Poor" threshold)'
      },
      ...
      { 
        ...
        threshold: 0.1, 
        severity: 'warning',
        description: 'Cumulative Layout Shift exceeds 0.1 (Google "Needs Improvement" threshold)'
      },
      { 
        metric: 'cls', 
        threshold: 0.25, 
        severity: 'error',
        description: 'Cumulative Layout Shift exceeds 0.25 (Google "Poor" threshold)'
      },
      ...
      { 
        ...
        threshold: 1800, 
        severity: 'warning',
        description: 'First Contentful Paint exceeds 1.8s (Google "Needs Improvement" threshold)'
      },
      { 
        metric: 'fcp', 
        threshold: 3000, 
        severity: 'error',
        description: 'First Contentful Paint exceeds 3s (Google "Poor" threshold)'
      },
      ...
      { 
        ...
        threshold: 1800, 
        severity: 'error',
        description: 'Time to First Byte exceeds 1.8s (poor performance threshold)'
      },
    ];
